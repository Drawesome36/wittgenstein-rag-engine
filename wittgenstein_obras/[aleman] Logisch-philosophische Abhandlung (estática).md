# Logisch-philosophische Abhandlung (estática)

**Fuente:** https://www.wittgensteinproject.org/w/index.php/Logisch-philosophische_Abhandlung_(statische_Darstellung_in_Baumstruktur)
...
[![Click here to report an error](/w/images/thumb/7/76/Flag.png/30px-Flag.png)](https://wittgensteinproject.org/forms/report-error.php?title=Logisch-philosophische%20Abhandlung%20\(statische%20Darstellung%20in%20Baumstruktur\) "Report an error")

Statische Darstellung des _Tractatus_ in Baumstruktur

  


[Go to interactive tree-like view](/w/index.php/Logisch-philosophische_Abhandlung_\(Darstellung_in_Baumstruktur\) "Logisch-philosophische Abhandlung \(Darstellung in Baumstruktur\)") · [Go to linear view](/w/index.php/Logisch-philosophische_Abhandlung "Logisch-philosophische Abhandlung")
...
Der Text dieser digitalen Ausgabe ist eine Reproduktion von L. Wittgenstein. _Tractatus Logico-Philosophicus_. Herausgegeben von C. K. Ogden und F. P. Ramsey, Kegan Paul, Trench, Trubner & Co., 1922. Diese Darstellung des _Tractatus_ in Baumstruktur wurde von David G. Stern entwickelt (Ludwig Wittgenstein. _["Tractatus Logico-Philosophicus": three parallel tree-structured editions](https://doi.org/10.15845/nwr.v11.3675)_. Herausgegeben von David G. Stern, Nordic Wittgenstein Review, N. 11, 2023). Wir bedanken uns herzlich bei David Sterne, welcher uns freundlicherweise diese Darstellung zur Verfügung gestellt hat. Dieses Werk ist gemeinfrei, weil seine urheberrechtliche Schutzfrist abgelaufen ist. Dies gilt für das Herkunftsland des Werks und alle weiteren Staaten mit einer gesetzlichen Schutzfrist von 70 oder weniger Jahren nach dem Tod des Urhebers. 
...
**4.062** Kann man sich nicht mit falschen Sätzen, wie bisher mit wahren, verständigen? Solange man nur weiss, dass sie falsch gemeint sind. Nein! Denn, wahr ist ein Satz, wenn es sich so verhält, wie wir es durch ihn sagen; und wenn wir mit „ _p_ “ ∼ _p_ meinen, und es sich so verhält wie wir es meinen, so ist „ _p_ “ in der neuen Auffassung wahr und nicht falsch. 
...
**4.1272** So ist der variable Name „ _x_ “ das eigentliche Zeichen des Scheinbegriffes Gegenstand. 
...
**4.24** Die Namen sind die einfachen Symbole, ich deute sie durch einzelne Buchstaben („ _x_ “, „ _y_ “, „ _z_ “) an. 
...
**5.5** Jede Wahrheitsfunktion ist ein Resultat der successiven Anwendung der Operation (– – – – –W)(_ξ, . . . ._) auf Elementarsätze. 
...
(WWWW)(_p_ , _q_)  | Tautologie  | (Wenn _p_ , so _p_ ; und wenn _q_ , so _q_.) (_p_ ⊃ _p . q_ ⊃ _q_)   
---|---|---  
...
**5.12** Insbesondere folgt die Wahrheit eines Satzes „ _p_ “ aus der Wahrheit eines anderen „ _q_ “, wenn alle Wahrheitsgründe des zweiten Wahrheitsgründe des ersten sind. 
...
**5.15** Ist _W r_ die Anzahl der Wahrheitsgründe des Satzes „ _r_ “, _W rs_ die Anzahl derjenigen Wahrheitsgründe des Satzes „ _s_ “, die zugleich Wahrheitsgründe von „ _r_ “ sind, dann nennen wir das Verhältnis: _W rs_ : _W r_ das Mass der Wahrscheinlichkeit, welche der Satz „ _r_ “ dem Satz „ _s_ “ gibt. 
...
**5.151** Sei in einem Schema wie dem obigen in No. 5.101 _W r_ die Anzahl der „ _W_ “ im Satze _r_ ; _W rs_ die Anzahl derjenigen „ _W_ “ im Satze _s_ , die in gleichen Kolonnen mit „ _W_ “ des Satzes _r_ stehen. Der Satz _r_ gibt dann dem Satze _s_ die Wahrscheinlichkeit: _W rs_ : _W r_. 
...
**5.51** Hat _ξ_ nur einen Wert, so ist [math]\displaystyle{ N ( \bar{\xi} ) }[/math] = ∼ _p_ (nicht _p_), hat es zwei Werte, so ist [math]\displaystyle{ N ( \bar{\xi} ) }[/math] = ∼ _p ._ ∼ _q_ (weder _p_ noch _q_). 

  


**5.52** Sind die Werte von _ξ_ sämtliche Werte einer Funktion _fx_ für alle Werte von _x_ , so wird [math]\displaystyle{ N ( \bar{\xi} ) }[/math] = ∼(∃ _x_) _. fx_. 
...
**5.515** Es muss sich an unseren Symbolen zeigen, dass das, was durch „∨“, „ _._ “, etc. miteinander verbunden ist, Sätze sein müssen. 
...
**5.532** Und analog: Nicht „(∃ _x, y_) _. f_ (_x, y_) _. x_ = _y_ “, sondern „(∃ _x_) _. f_ (_x, x_)“; und nicht „(∃ _x, y_) _. f_ (_x, y_) _._ ∼ _x_ = _y_ “, sondern „(∃ _x, y_) _. f_ (_x, y_)“. 
...
**5.542** Es ist aber klar, dass „A glaubt, dass _p_ “, „A denkt _p_ “, „A sagt _p_ “ von der Form „‚ _p_ ‘ sagt _p_ “ sind: Und hier handelt es sich nicht um eine Zuordnung von einer Tatsache und einem Gegenstand, sondern um die Zuordnung von Tatsachen durch Zuordnung ihrer Gegenstände. 
...
![](/w/images/thumb/8/89/TLP_5.6331.png/250px-TLP_5.6331.png)
...
**6.1203** Um eine Tautologie als solche zu erkennen, kann man sich, in den Fällen, in welchen in der Tautologie keine Allgemeinheitsbezeichnung vorkommt, folgender anschaulichen Methode bedienen: Ich schreibe statt „ _p_ “, „ _q_ “, „ _r_ “ etc. „W _p_ F“, „W _q_ F“, „W _r_ F“ etc. Die Wahrheitskombinationen drücke ich durch Klammern aus. z. B.: 

![](/w/images/thumb/f/ff/TLP_6.1203a.png/250px-TLP_6.1203a.png)
...
* * *
  ...
  1. ↑ 1.0 1.1 Die Decimalzahlen als Nummern der einzelnen Sätze deuten das logische Gewicht der Sätze an, den Nachdruck, der auf ihnen in meiner Darstellung liegt. Die Sätze _n_.1, _n_.2, _n_.3, etc., sind Bemerkungen zum Satze No. _n_ ; die Sätze _n_._m_ 1, _n_._m_ 2, etc. Bemerkungen zum Satze No. _n_._m_ ; und so weiter.



Retrieved from "[https://www.wittgensteinproject.org/w/index.php?title=Logisch-philosophische_Abhandlung_(statische_Darstellung_in_Baumstruktur)&oldid=11296](https://www.wittgensteinproject.org/w/index.php?title=Logisch-philosophische_Abhandlung_\(statische_Darstellung_in_Baumstruktur\)&oldid=11296)"
